              ...
              <Navbar expand="lg" className="myNav">
                <Container fluid>
                  <Navbar.Brand href="#home">
                    <p style={{ color: "#ffffff" }}>Akash Kumar</p>
                  </Navbar.Brand>
                  <Navbar.Toggle
            ...
            <div className="profile-parent col-md-12 mt-0 mb-5 p-5">
              <div className="profile-details">
                ...
                <div className="profile-details-name">
                  ...
                  <span className="highlighted-text">Akash Kumar</span>
                </div>
                  ...
                  <span className="primary">
                    ...
                    <h1>
                      ...
                      <Typical
                        ...
                        loop={Infinity}
                        steps={["Web Developer", 2000, "Problem Solver", 2000]}
                      />
                    </h1>
                ...
                <div className="profile-option">
                  <a
                    ...
                    download="Akash-Kumar-Resume.pdf"
                  >
