      ...
      <div className="containerDiv">
        <div className="aboutmeTextDiv">
          <p className="aboutme">
            ...
            ReactJs to ExpressJs, MongoDB, NodeJs
          </p>
          <ul>
            <li>
              I have worked on several different projects solo as well as
              collaboratively
            </li>
          ...
          <p className="aboutme">
            Looking to start the career as a web developer
          </p>
          ...
          <div className="colzs">
            <div className="colz-icons">
              <a
                ...
                href="http://www.linkedin.com/in/akash-kumar06"
              >
              ...
              <a
                ...
                href="https://github.com/Krakash06"
              >
          ...
          <div className="aboutBtnDiv">
            ...
            <a href="Akash-Kumar-Resume.pdf" download="Akash-Kumar-Resume.pdf">
